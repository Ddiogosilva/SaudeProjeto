            ...
            Se preferir, ligue para (11) 1234-5678, de segunda a sexta, das 9h às 18h.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- to get an API token!-->
                        <form action="{{route( 'envia-Contato' )}}" method="post" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            <!-- Name input-->
                            @csrf
                            ...
                            <!-- Message input-->
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="message" type="text" name = "mensagem" placeholder="Digite sua mensagem aqui..." style="height: 10rem" data-sb-validations="required"></textarea>
                            ...
                            <!-- Submit Button-->
                            <button class="btn btn-primary btn-xl enable" id="submitButton" type="submit">Enviar</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <img class="img-fluid rounded mb-5" src="imagens/pressaoInstrucao.png" alt="..." />
                    ...
                    <div class="modal-body text-center pb-5">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <!-- Portfolio Modal - Title-->
                                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Exame de sangue</h2>
                                    <!-- Icon Divider-->
                                    <div class="divider-custom">
                                        <div class="divider-custom-line"></div>
                                        <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
